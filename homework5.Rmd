...
log_posterior <- function(theta) {
  ...
  if(any(prob == 0) | any(prob == 1))
    -Inf ## log likelihood is -Inf if prob=0 or 1
  else
...
```
The standard deviation of the 'true skill' is smaller. This makes sense because there is less variation of the true skill given a longer period of time, rather than just a month.
...
hist(exp(global_mu)/(1+exp(global_mu)))
```

False, We have a good estimate for these 10 players but this is not an accurate representation globaly
